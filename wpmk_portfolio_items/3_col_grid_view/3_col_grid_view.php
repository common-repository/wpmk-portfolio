<?php
/**
 * WPMK Portfolio 3 Column Grid View Template
...
?>
<!-- 3 Column Grid View Start -->
<div class="wpmk-portfolio-3-col <?php wpmk_portfolio_animate_class(); ?><?php wpmk_portfolio_get_terms_class(get_the_ID()); ?>">
    
    <!-- 3 Column Grid View Title Start -->
    <h6 class="wpmk-title"><?php the_title(); ?></h6>
    <!-- 3 Column Grid View Title End -->
    
    <!-- 3 Column Grid View Featured Image Start -->
    <div class="wpmk-portfolio-image">
        <!-- 3 Column Grid View Excerpt Start -->
        <?php
    ...
    <!-- 3 Column Grid View View Project End -->
    <?php endif; ?>
    
</div>
<!-- 3 Column Grid View End -->
<?php
if ($wpmk_portfolio_count % 3 == 0) {
